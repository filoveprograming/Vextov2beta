...
v0:Notify({Title = "Vexto V3", Content = "Client is 100% Loaded", SubContent = "", Duration = 2 + 3})
wait(1 + 1)
v0:Notify({Title = "Vexto Version", Content = "Checking If Status is UpToDate", SubContent = "", Duration = 14 - 9})
wait(2)
v0:Notify({Title = "Vexto Version", Content = "Status: UpToDate", SubContent = "", Duration = 5})
wait(7 - 4)
...
v6.Credits:AddParagraph(
    {Title = "👋 Welcome " .. v4.LocalPlayer.Name .. "! 🎉", Content = "Enjoy your experience with Vexto V3"}
)
local v9 = v6.Credits:AddSection("Script Owned")
v6.Credits:AddParagraph({Title = "👑 | Creators", Content = "Fivestarlit / ._.bbcrashout_1"})
local v9 = v6.Credits:AddSection("Socials")
local v14 = {Discord = "https://discord.gg/D8Eyn6Rc", YouTube = "https://youtube.com/@infinitescriptz?si=fsM71N0W68Ax206m"}
...
local function v99()
    ...
    v304.Image = "rbxassetid://90242096243209"
...
local function v99()
    ...
    v389.Text = "JOIN THE DISCORD VEXTO V2 EZ"
    ...
    v399.Image = "rbxassetid://90242096243209"
